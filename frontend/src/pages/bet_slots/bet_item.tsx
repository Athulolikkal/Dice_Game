...
const BetItemList = () => {
  ...
  const betType = useSelector((state: any) => state.gameInfo.betType);
  ...
  return (
    <>
                ...
                <CardContent sx={{ flex: "1 0 auto" }}>
                  ...
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Typography
                      component="div"
                      variant="h4"
                      sx={{ fontWeight: "bold", color: bet.color }}
                    >
                      {bet.amount}
                    </Typography>
                  </Box>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Do you want to play {betType} challenge for {selectedPoint} points
          </DialogContentText>
        </DialogContent>
        <DialogActions>
